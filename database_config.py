...
CREATE_TABLES_SQL = {
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        session_id VARCHAR(255) NULL COMMENT '当前会话ID',
        app_type VARCHAR(50) NULL COMMENT '当前应用类型',
        device_info VARCHAR(500) NULL COMMENT '当前设备信息',
        ip_address VARCHAR(50) NULL COMMENT '当前IP地址',
    ...
    CREATE TABLE IF NOT EXISTS interactions (
        ...
        username VARCHAR(100) NULL COMMENT '用户名（账户名）',
    ...
    CREATE TABLE IF NOT EXISTS reading_progress (
        ...
        completion_mode ENUM('text', 'audio') NULL COMMENT '完成方式：文字模式、音频模式',
