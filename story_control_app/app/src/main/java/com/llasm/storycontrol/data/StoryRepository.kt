...
class StoryRepository {
    ...
    private fun initializeStories() {
        ...
        // 继续添加更多故事，确保有足够的内容
        for (i in 16..31) {
            val dateStr = "2024-01-${i.toString().padStart(2, '0')}"
