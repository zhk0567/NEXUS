...
class AIService(private val context: Context) {
    ...
    companion object {
        ...
        private const val VOLCANO_ACCESS_KEY = "2AmQpw1aTtuIaRdMcrPX7K4PChZWus82" // 从原项目获取的真实Access Key
        private const val VOLCANO_APP_ID = "9065017641" // 从原项目获取的真实App ID
        private const val VOLCANO_RESOURCE_ID = "volc.speech.dialog" // 从原项目获取的真实Resource ID
        private const val VOLCANO_APP_KEY = "1-QSPcc75MckNFBAJqQK63KJTNhbDu0d" // 从原项目获取的真实App Key
